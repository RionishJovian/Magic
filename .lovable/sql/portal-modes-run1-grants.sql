-- Lovable Cloud SQL Editor — RUN 1 of 2
-- Portal guest modes + owner/role grants. Paste ONLY this SQL (no markdown).
...
CREATE POLICY "portal_mode_role_defaults platform write" ON public.portal_mode_role_defaults FOR ALL TO authenticated
