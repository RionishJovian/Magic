-- Lovable Cloud SQL Editor — default data-quota voucher plans (one paste).
-- Adds 500MB / 1GB / 2GB / 3GB / 5GB / 7GB / 10GB templates to every tenant.
-- Existing 1D / 7D / 1M / VIP plans are left as-is. Prices stay editable.
