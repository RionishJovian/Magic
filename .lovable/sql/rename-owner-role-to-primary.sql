...
--
-- If Primary/Developer pages still fail with
--   invalid input value for enum app_role: "owner"
-- after this file, also paste:
--   .lovable/sql/fix-owner-app-role-rls-sweep.sql
-- That sweep rewrites leftover RLS policies + function bodies.
