-- Lovable Cloud SQL Editor — standard prices 95k / 104.5k with 30% grand-opening promo
-- Window unchanged: 23 Aug 2026 → 24 Sep 2026 inclusive (Asia/Yangon). Safe to re-run.
