# Do Magic Dude AI Chatbot

> Status: proposed design document (not implemented). Exported from the plan editor.
> Scope note: MikroTik Magic is under a stability freeze — this document is product/technical
> context only, and no code ships from it until explicitly approved.
